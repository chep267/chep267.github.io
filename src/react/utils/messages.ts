...
const messages: MessagesType = Object.freeze({
    [localeObject.vi]: Object.assign({}, VI_BASE, VI_AUTH, VI_LANG, VI_THEME, VI_FEED, VI_MESS, VI_GLOBAL),
    [localeObject.en]: Object.assign({}, EN_BASE, EN_AUTH, EN_LANG, EN_THEME, EN_FEED, EN_MESS, EN_GLOBAL),
});
