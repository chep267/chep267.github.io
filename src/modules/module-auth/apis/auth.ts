...
export const apiSignIn = async (payload: AuthApiProps['SignIn']['Payload']): Promise<AuthApiProps['SignIn']['Response']> => {
...
export const apiSignOut = async (
    payload: AuthApiProps['SignOut']['Payload']
): Promise<AuthApiProps['SignOut']['Response']> => {
...
export const apiRegister = async (
    payload: AuthApiProps['Register']['Payload']
): Promise<AuthApiProps['Register']['Response']> => {
    const { timer = timePendingApi, email, password } = payload;
    const [response] = await Promise.all([createUserWithEmailAndPassword(authentication, email, password), debounce(timer)]);
    return response;
};

export const apiRecover = async (
    payload: AuthApiProps['Recover']['Payload']
): Promise<AuthApiProps['Recover']['Response']> => {
...
export const apiRestart = async (
    payload: AuthApiProps['Restart']['Payload']
): Promise<AuthApiProps['Restart']['Response']> => {
